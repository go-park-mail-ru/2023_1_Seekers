...
type Config struct {
	...
	Routes struct {
		...
		// MailRoutes
		RouteGetFolderMessages string `yaml:"route_get_folder_messages" env-default:"/folder/{slug}"`
		RouteGetFolders        string `yaml:"route_get_folders" env-default:"/folders"`
		RouteGetMessage        string `yaml:"route_get_message" env-default:"/message/{id:[0-9]+}"`
