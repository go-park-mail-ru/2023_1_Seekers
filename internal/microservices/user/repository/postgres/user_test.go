...
func TestRepository_Create(t *testing.T) {
	...
	mock.ExpectBegin()
	mock.ExpectQuery(regexp.QuoteMeta(`INSERT INTO "users" ("email","password","first_name","last_name","avatar")
	VALUES ($1,$2,$3,$4,$5) RETURNING "user_id"`)).WithArgs(fakeDBUser.Email, fakeDBUser.Password, fakeDBUser.FirstName, fakeDBUser.LastName,
