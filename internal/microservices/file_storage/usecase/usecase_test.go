...
import (
	...
	mockS3Repo "github.com/go-park-mail-ru/2023_1_Seekers/internal/microservices/file_storage/repository/mocks"
...
func TestUseCase_Get(t *testing.T) {
	...
	s3Repo := mockS3Repo.NewMockFileStorageRepoI(ctrl)
	s3UC := New(s3Repo)
