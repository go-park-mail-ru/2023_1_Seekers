...
func (m *MockUseCaseI) CreateAnonymousEmail(userID uint64) (string, error) {
	m.ctrl.T.Helper()
...
// DeleteAnonymousEmail mocks base method.
func (m *MockUseCaseI) DeleteAnonymousEmail(userID uint64, fakeEmail string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAnonymousEmail", userID, fakeEmail)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAnonymousEmail indicates an expected call of DeleteAnonymousEmail.
func (mr *MockUseCaseIMockRecorder) DeleteAnonymousEmail(userID, fakeEmail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAnonymousEmail", reflect.TypeOf((*MockUseCaseI)(nil).DeleteAnonymousEmail), userID, fakeEmail)
}
...
// GetAnonymousEmails mocks base method.
func (m *MockUseCaseI) GetAnonymousEmails(userID uint64) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAnonymousEmails", userID)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAnonymousEmails indicates an expected call of GetAnonymousEmails.
func (mr *MockUseCaseIMockRecorder) GetAnonymousEmails(userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAnonymousEmails", reflect.TypeOf((*MockUseCaseI)(nil).GetAnonymousEmails), userID)
}
...
// GetMessagesByFakeEmail mocks base method.
func (m *MockUseCaseI) GetMessagesByFakeEmail(userID uint64, fakeEmail string) ([]models.MessageInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMessagesByFakeEmail", userID, fakeEmail)
	ret0, _ := ret[0].([]models.MessageInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetMessagesByFakeEmail indicates an expected call of GetMessagesByFakeEmail.
