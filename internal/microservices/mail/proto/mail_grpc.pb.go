...
func (c *mailServiceClient) CreateAnonymousEmail(ctx context.Context, in *UID, opts ...grpc.CallOption) (*CreateAnonymous, error) {
	...
	err := c.cc.Invoke(ctx, "/mail_proto.MailService/CreateAnonymousEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailServiceClient) GetAnonymousEmails(ctx context.Context, in *UID, opts ...grpc.CallOption) (*GetAnonymous, error) {
	...
	err := c.cc.Invoke(ctx, "/mail_proto.MailService/GetAnonymousEmails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailServiceClient) DeleteAnonymousEmail(ctx context.Context, in *Anonymous, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, "/mail_proto.MailService/DeleteAnonymousEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailServiceClient) GetMessagesByFakeEmail(ctx context.Context, in *Anonymous, opts ...grpc.CallOption) (*MessagesInfoResponse, error) {
	out := new(MessagesInfoResponse)
	err := c.cc.Invoke(ctx, "/mail_proto.MailService/GetMessagesByFakeEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mailServiceClient) GetOwnerEmailByFakeEmail(ctx context.Context, in *GetOwnerAnonymousParams, opts ...grpc.CallOption) (*GetOwnerAnonymousResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mail_proto.MailService/GetOwnerEmailByFakeEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MailService_CreateAnonymousEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail_proto.MailService/CreateAnonymousEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MailService_GetAnonymousEmails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail_proto.MailService/GetAnonymousEmails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MailService_DeleteAnonymousEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail_proto.MailService/DeleteAnonymousEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MailService_GetMessagesByFakeEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail_proto.MailService/GetMessagesByFakeEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MailService_GetOwnerEmailByFakeEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mail_proto.MailService/GetOwnerEmailByFakeEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
